...
const Game = () => {
  ...
  return (
    <>
      <div className="flex flex-col xl:justify-center xl:items-center gap-2 lg:px-6 w-full max-h-96 lg:mt-4 xl:mt-0 xl:max-h-full">
        <AnimatePresence
          initial={false}
          mode="wait"
      ...
      >
        {shouldAnimateAnswers && (
          <MotionDiv
            ...
            exit={{ opacity: 0, y: 20 }}
            className="flex flex-col gap-y-4 justify-start w-full"
            key={currentQuestion} // Asegúrate de proporcionar una clave única para que React maneje las animaciones correctamente
          >
            <Answers
